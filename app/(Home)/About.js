        ...
        <div id="About" className="mb-10 w-full text-center flex flex-col pt-5">
            ...
            <section className="h-fit w-full grid grid-cols-2 max-md:grid-cols-1">
                <Card className={"bg-background/10 rounded-none"}>
                    <CardHeader>
                        <CardTitle className="text-4xl text-left max-sm:text-[30px] max-md:text-6xl font-bold text-neutral-600 dark:text-neutral-200">
                            Our Vision
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="text-xl text-balance font-light text-foreground/70 text-left max-md:text-xl">
                ...
                <Card className={"bg-background/10 rounded-none"}>
                    <CardHeader>
                        <CardTitle className="text-4xl max-sm:text-[30px] text-left max-md:text-6xl font-bold text-neutral-600 dark:text-neutral-200">
                            Our Mission
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="text-xl text-balance text-foreground/70 font-light text-left max-md:text-xl ">
